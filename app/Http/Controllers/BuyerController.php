...
public function purchase(Request $request, Product $product)
{
    ...
    public function checkout(Order $order)
    {
        ...
        return view('buyer.checkout', compact('order', 'cartItems', 'subtotal', 'deliveryCost', 'total'));
    }
...
public function processPayment(Request $request, Order $order)
{
    ...
    Notification::create([
        ...
        'message' => "Your payment of Ksh " . number_format($order->total_amount, 2) . " for order #{$order->id} was successful. Receipt: {$mpesaReceipt}",
        'type' => 'success'
    ]);
    ...
    Notification::create([
        ...
        'title' => 'Order Paid',
        'message' => "Order #{$order->id} has been paid. Amount: Ksh " . number_format($order->total_amount, 2),
        'type' => 'success'
    ]);
...
private function generateReceiptContent(Order $order)
{
    ...
    $content .= "Total Amount: Ksh " . number_format($order->total_amount, 2) . "\n\n";
